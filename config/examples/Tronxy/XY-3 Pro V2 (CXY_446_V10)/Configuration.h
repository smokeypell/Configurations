...
#define STRING_CONFIG_H_AUTHOR "(Smokey Pell, Tronxy XY-3 PROv2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME     "XY-3 PRO v2"
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 766.22 } // Default from Tronxy for XY-3 Pro V2 with BMG clone extruder.
                                                                        // When extruding 100mm of filament, only 94mm extrudes.

#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 815.13 } // Calibrated extruder steps/mm for Tronxy BMG clone extruder.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35.6, -32.12, 0 }
 ...
 */
#if ENABLED(TFT_CLASSIC_UI) || ENABLED(TFT_COLOR_UI)
...
#define PREHEAT_2_LABEL           "PLA+/Meta"
...
#define TOUCH_SCREEN
  ...
  #if ENABLED(TFT_COLOR_UI) || ENABLED(TFT_CLASSIC_UI)
